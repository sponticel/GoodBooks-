...
@camp = Book.create!(
  ...
  Review.create!(rating: 4, content:'This book was great!', user:@user, book:@thunderhead)
  Review.create!(rating: 3, content:'What a rollercoaster!', user:@user, book:@sadie)
  Review.create!(rating: 3, content:'very suspensful did net see the ending coming', user:@user, book:@verity)
  Review.create!(rating: 5, content:'Fun for the kiddos', user:@user, book:@camp)
  Review.create!(rating: 4, content:'You will enjoy if you want to try scary but not too scary', user:@user, book:@layla)
  Review.create!(rating: 4, content:'Loved it!', user:@user_2, book:@layla)
